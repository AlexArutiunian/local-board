...
Совместная realtime-доска для занятий: преподаватель создаёт комнату, отправляет ученику ссылку или сообщает короткий код, и все участники видят рисунок друг друга во время письма.
...
- защита от stuck pointer при `pointercancel`/потере pointer capture;
...
Ученику можно отправить ссылку кнопкой **«Поделиться»** или просто сообщить четыре цифры.
