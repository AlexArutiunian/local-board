...
- Pencil-only рисование; один палец — pan, два — pinch zoom;
- ластик работает Apple Pencil и мышью и удаляет рукописные штрихи целиком;
...
| Undo/Redo ink | `Ctrl/Cmd+Z`, `Ctrl/Cmd+Shift+Z` |
